    ...
    initializer 'foreman_statistics.register_plugin', :before => :finisher_hook do |_app|
      Foreman::Plugin.register :foreman_statistics do
        ...
        security_block :foreman_statistics do
          ...
          permission :view_trends,     { :trends => %i[index show welcome],
                                         :"api/v2/trends" => %i[index show] },
            :resource_type => 'ForemanStatistics::Trend'
          permission :create_trends,   { :trends => %i[new create],
                                         :"api/v2/trends" => %i[new create] },
            :resource_type => 'ForemanStatistics::Trend'
          permission :edit_trends,     { :trends => %i[edit update] },
            :resource_type => 'ForemanStatistics::Trend'
          permission :destroy_trends,  { :trends => [:destroy],
                                         :"api/v2/trends" => [:destroy] },
            :resource_type => 'ForemanStatistics::Trend'
          permission :update_trends,   { :trends => [:count] },
            :resource_type => 'ForemanStatistics::Trend'
        end
